                    ...
                    <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                        @foreach ($lines as $index => $line)
                            <tr>
                                ...
                                <td class="px-4 py-3">
                                    <input wire:model.live.debounce.400ms="lines.{{ $index }}.debit" wire:change="checkBudgetWarning({{ $index }})" type="number" step="0.01" class="w-full px-2.5 py-1.5 text-right font-mono font-bold bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-xs text-indigo-600 dark:text-indigo-400" />
                                </td>
                                <td class="px-4 py-3">
                                    <input wire:model.live.debounce.400ms="lines.{{ $index }}.credit" type="number" step="0.01" class="w-full px-2.5 py-1.5 text-right font-mono font-bold bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-xs text-purple-600 dark:text-purple-400" />
                                </td>
