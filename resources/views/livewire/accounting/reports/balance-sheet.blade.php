    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-3">
        ...
        <div class="flex items-center gap-3">
            <x-report-export-dropdown 
                :pdfUrl="route('accounting.reports.export.pdf', ['type' => 'balance-sheet', 'as_of_date' => $asOfDate, 'unit' => $unitFilter])"
                :excelUrl="route('accounting.reports.export.excel', ['type' => 'balance-sheet', 'as_of_date' => $asOfDate, 'unit' => $unitFilter])"
            />
            @if ($isBalanced)
