        ...
        <div class="flex items-center gap-2">
            @if($selectedAccountId)
                <x-report-export-dropdown 
                    :pdfUrl="route('accounting.reports.export.pdf', ['type' => 'subsidiary-ledger', 'account_id' => $selectedAccountId, 'start_date' => $startDate, 'end_date' => $endDate, 'unit' => $unitFilter])"
                    :excelUrl="route('accounting.reports.export.excel', ['type' => 'subsidiary-ledger', 'account_id' => $selectedAccountId, 'start_date' => $startDate, 'end_date' => $endDate, 'unit' => $unitFilter])"
                />
            @endif
        </div>
    </div>
