        ...
        <div class="flex items-center gap-2">
            @if($selectedAccountId)
                <x-report-export-dropdown 
                    :pdfUrl="route('accounting.reports.export.pdf', ['type' => 'general-ledger', 'account_id' => $selectedAccountId, 'start_date' => $startDate, 'end_date' => $endDate, 'unit' => $unitFilter])"
                    :excelUrl="route('accounting.reports.export.excel', ['type' => 'general-ledger', 'account_id' => $selectedAccountId, 'start_date' => $startDate, 'end_date' => $endDate, 'unit' => $unitFilter])"
                />
            @endif
        </div>
    </div>
