    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-3">
        ...
        <div class="flex items-center gap-2">
            <x-report-export-dropdown 
                :pdfUrl="route('accounting.reports.export.pdf', ['type' => 'profit-loss', 'start_date' => $startDate, 'end_date' => $endDate, 'unit' => $unitFilter])"
                :excelUrl="route('accounting.reports.export.excel', ['type' => 'profit-loss', 'start_date' => $startDate, 'end_date' => $endDate, 'unit' => $unitFilter])"
            />
