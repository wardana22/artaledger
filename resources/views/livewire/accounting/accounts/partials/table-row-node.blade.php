        ...
        <div class="inline-flex items-center justify-end gap-1">
            @if ($account->is_group)
                @can('accounts.create')
                    <button 
                        ...
                        class="p-1 rounded-lg text-emerald-600 hover:text-emerald-700 hover:bg-emerald-500/10 dark:text-emerald-400 transition-all">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            @can('accounts.edit')
                <button 
                    ...
                    title="Edit Akun"
                    class="p-1 rounded-lg text-slate-400 hover:text-indigo-600 hover:bg-indigo-500/10 dark:hover:text-indigo-400 transition-all">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            @can('accounts.delete')
                <button 
                    ...
                    title="Hapus Akun"
                    class="p-1 rounded-lg text-slate-400 hover:text-rose-600 hover:bg-rose-500/10 dark:hover:text-rose-400 transition-all">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
