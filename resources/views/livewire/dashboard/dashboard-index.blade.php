    ...
    <div class="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div class="flex flex-wrap items-center gap-3">
            @can('dashboard.settings')
                <a href="{{ route('dashboard.settings.index') }}" wire:navigate class="px-4 py-2 rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 text-xs font-bold inline-flex items-center gap-2 transition-all shadow-sm">
            ...
            <button wire:click="refreshData" wire:loading.attr="disabled" class="px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold inline-flex items-center gap-2 transition-all shadow-sm shadow-indigo-500/20 cursor-pointer">
