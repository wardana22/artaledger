...
@if ($logoUrl)
    <img src="{{ $logoUrl }}" alt="{{ $appName }}" {{ $attributes->merge(['class' => 'h-8 max-h-8 w-auto max-w-[120px] rounded-lg object-contain bg-white/10 dark:bg-slate-800/50 p-0.5 shadow-sm border border-slate-200/50 dark:border-slate-700/50']) }} />
@else
